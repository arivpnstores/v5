...
BURIQ () {                                           curl -sS  https://raw.githubusercontent.com/arivpnstores/izin/main/ip > /root/tmp
...
Name=$(curl -sS curl -sS  https://raw.githubusercontent.com/arivpnstores/izin/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS curl -sS  https://raw.githubusercontent.com/arivpnstores/izin/main/ip | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • ARI STUNNEL V5•                  $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo ""
